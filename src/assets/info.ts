export const myBio =
  "Hello, world! 👋 My name, if you couldn't tell from the header, is Ian Cowan. I am an airline pilot and programmer and love learning new things in both the aviation and computer science field. I began flying in 2017 and since have obtained by airline transport pilot certificate along with my CFI-I certificate. Flying and programming are two of my passions and I love to work on projects that combine these together.<br /><br />Please have fun exploring my bare bones CLI website and finding some of the easter eggs I have hidden. You can also find this project on GitHub, but finding the easter eggs that way is cheating!";
